...
ที่คัดลอกมา) แต่ยังไม่เคยทดสอบกับ API key จริง** — ทดสอบด้วยสลิปจริงก่อนเปิดใช้ (โดยเฉพาะการอ่านข้อมูลผู้รับ ซึ่งรูปแบบการปิดบังเลข
...
ทดสอบ: `npm run test:payment` (28 เคส)
